...
AND sysobjects.name NOT LIKE'trIU%'
AND OBJECT_NAME(parent_obj) = 'CourtCaseWFAction'
ORDER BY table_name
...
EXEC [DEV-RWA_IECMS-DE_Live_20170913].[dbo].[sync_UpdateReportingTables]
