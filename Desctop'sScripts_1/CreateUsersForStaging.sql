...
USE [DEV-RWA_IECMS-DATA_Live_20170810]
...
BEGIN
	USE [DEV-RWA_IECMS-KB_Live_20170810]
...
BEGIN TRY
    ...
    WHILE ( @UserTopIndex <= @UserCount )
        BEGIN
            ...
            --SET IDENTITY_INSERT [DEV-RWA_IECMS-DATA_Live_20170810].dbo.C_User ON 
			     
            INSERT  INTO [DEV-RWA_IECMS-DATA_Live_20170810].dbo.C_User
                    ( UserID ,
                      Name_ENG ,
                      --UserGUID ,
                      UserInitials ,
            ...
            --SET IDENTITY_INSERT [DEV-RWA_IECMS-DATA_Live_20170810].dbo.C_User OFF


            INSERT  [DEV-RWA_IECMS-DATA_Live_20170810].dbo.C_UserGroup
                    ( UserID, GroupID )
			SELECT @UserID , GroupID
			FROM [DEV-RWA_IECMS-DATA_Live_20170810].dbo.C_UserGroup
			WHERE UserID = @CopyFromUserID

            INSERT  [DEV-RWA_IECMS-DATA_Live_20170810].dbo.UserRole
                    ( UserID, RoleID )
			SELECT @UserID , RoleID
			FROM [DEV-RWA_IECMS-DATA_Live_20170810].dbo.UserRole
			WHERE UserID = @CopyFromUserID
