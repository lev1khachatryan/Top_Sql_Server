...
$Path082 = "\\sis2s082\BACKUP\RWA_IECMS\FromCountry\Live\"
...
If($YesOrNo -eq 'y'){
    If($ServerName -like "*013"){
        ...
        New-Item -Path $Path013 -name $FullDBFolderName -ItemType "directory"
        }
        Else { 
    ...
    else 
    {
        If($ServerName -like "*082"){
            ...
            New-Item -Path $Path082 -name $FullDBFolderName -ItemType "directory"
            }
            Else { 
                "The $Location path is already there." 
            }
    ...
    If($ServerName -like "*013"){
        ...
        New-Item -Path $Path013 -name $DiffDBFolderName -ItemType "directory"
        }
        Else { 
            "The $Location path is already there." 
        }
    ...
    else 
    {
        If($ServerName -like "*082"){
            ...
            New-Item -Path $Path082 -name $DiffDBFolderName -ItemType "directory"
            }
            Else { 
                "The $Location path is already there." 
            }
...
If($YesOrNo -eq 'y')
{
    ...
    { 
        If($ServerName -like "*082"){
            ...
            RESTORE DATABASE [DEV-RWA_IECMS-KB_Live_" + $DiffDBDate + "] 
            FROM  DISK = N'C:\BACKUP\RWA_IECMS\FromCountry\Live\" + $FullDBFolderName + "\DEV-RWA_IECMS-KB_DB_FULL_backup_" + $FullDBDate + ".bak' 
            WITH  FILE = 1,  
            MOVE N'IDM-Kb-Dev-Release-7.61' TO N'C:\DEFAULT.DATA\DEV-RWA_IECMS-KB_Live_" + $DiffDBDate + "_20160130_17_27.mdf',  
            MOVE N'IDM-Kb-Dev-Release-7.61_DATA' TO N'C:\DEFAULT.DATA\IDM-Kb-Dev-Release-7.61_DATA_Live_" + $DiffDBDate + ".ndf',  
            MOVE N'IDM-Kb-Dev-Release-7.61_INDEX' TO N'C:\DEFAULT.DATA\IDM-Kb-Dev-Release-7.61_INDEX_Live_" + $DiffDBDate + ".ndf',  
            MOVE N'IDM-Kb-Dev-Release-7.61_log' TO N'C:\DEFAULT.LOG\DEV-RWA_IECMS-KB_Live_" + $DiffDBDate + "_20160130_17_27_Log.ldf',  
            NOUNLOAD,  STATS = 5
            "
            ...
            RESTORE DATABASE [DEV-RWA_IECMS-DATA_Live_" + $DiffDBDate + "] 
            FROM  DISK = N'C:\BACKUP\RWA_IECMS\FromCountry\Live\" + $FullDBFolderName + "\DEV-RWA_IECMS-DATA_DB_FULL_backup_" + $FullDBDate + ".bak' 
            WITH  FILE = 1,  
            MOVE N'IDM-Data-Dev-Release-7.61' TO N'C:\DEFAULT.DATA\DEV-RWA_IECMS-DATA_Live_" + $DiffDBDate + "_20160130_17_14.mdf',  
            MOVE N'IDM-Data-Dev-Release-7.61_DATA' TO N'C:\DEFAULT.DATA\IDM-Data-Dev-Release-7.61_DATA_Live_" + $DiffDBDate + ".ndf',  
            MOVE N'IDM-Data-Dev-Release-7.61_INDEX' TO N'C:\DEFAULT.DATA\IDM-Data-Dev-Release-7.61_INDEX_Live_" + $DiffDBDate + ".ndf',  
            MOVE N'IDM-Data-Dev-Release-7.61_log' TO N'C:\DEFAULT.LOG\DEV-RWA_IECMS-DATA_Live_" + $DiffDBDate + "_20160130_17_14_Log.ldf',  
            NOUNLOAD,  STATS = 5
            "
            ...
            RESTORE DATABASE [DEV-RWA_IECMS-DE_Live_" + $DiffDBDate + "] 
            FROM  DISK = N'C:\BACKUP\RWA_IECMS\FromCountry\Live\" + $FullDBFolderName + "\DEV-RWA_IECMS-DE_DB_FULL_backup_" + $FullDBDate + ".bak' 
            WITH  FILE = 1,  
            MOVE N'cu_RWA_IECMS' TO N'C:\DEFAULT.DATA\DEV-RWA_IECMS-DE_Live_" + $DiffDBDate + "_20160130_17_14.mdf',  
            MOVE N'cu_RWA_IECMS_DATA' TO N'C:\DEFAULT.DATA\cu_RWA_IECMS_DATA_Live_" + $DiffDBDate + ".ndf',  
            MOVE N'cu_RWA_IECMS_INDEX' TO N'C:\DEFAULT.DATA\cu_RWA_IECMS_INDEX_Live_" + $DiffDBDate + ".ndf',  
            MOVE N'cu_RWA_IECMS_log' TO N'C:\DEFAULT.LOG\DEV-RWA_IECMS-DE_Live_" + $DiffDBDate + "_20160130_17_14_Log.ldf',  
            NOUNLOAD,  STATS = 5
            "
    ...
    else 
    {
        If($ServerName -like "*082"){
            ...
            NORECOVERY,  NOUNLOAD,  STATS = 5
            RESTORE DATABASE [DEV-RWA_IECMS-KB_Live_" + $DiffDBDate + "] 
            FROM  DISK = N'C:\BACKUP\RWA_IECMS\FromCountry\Live\20170213_Diff\DEV-RWA_IECMS-KB_DB_DIFF_backup_" + $DiffDBDate + ".bak' 
            WITH  FILE = 1,  NOUNLOAD,  STATS = 5
            "
            ...
            NORECOVERY,  NOUNLOAD,  STATS = 5
            RESTORE DATABASE [DEV-RWA_IECMS-DATA_Live_" + $DiffDBDate + "] 
            FROM  DISK = N'C:\BACKUP\RWA_IECMS\FromCountry\Live\" + $DiffDBFolderName + "\DEV-RWA_IECMS-DATA_DB_DIFF_backup_" + $DiffDBDate + ".bak' 
            WITH  FILE = 1,  NOUNLOAD,  STATS = 5
            "
            ...
            NORECOVERY,  NOUNLOAD,  STATS = 5
            RESTORE DATABASE [DEV-RWA_IECMS-DE_Live_" + $DiffDBDate + "] 
            FROM  DISK = N'C:\BACKUP\RWA_IECMS\FromCountry\Live\" + $DiffDBFolderName + "\DEV-RWA_IECMS-DE_DB_DIFF_backup_" + $DiffDBDate + ".bak' 
            WITH  FILE = 1,  NOUNLOAD,  STATS = 5
            "
