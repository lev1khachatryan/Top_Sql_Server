...
[User] ,
[Role]  FROM  #Mappings3
WHERE [Server] = @@SERVERNAME   AND IsActive = 0 AND  ISNULL(@db,[Database]) = [Database] AND [Database]  IN ('*')
            ...
            BEGIN
                ...
                IF @FromWinGroup = 1 
                    SET @sql = @sqlDB
                        ...
                        + 'BEGIN' + CHAR(13) + 'CREATE USER ' +'['+ @User+']'
                        + ' FOR LOGIN ' + '[' +  @Login + ']'
                        + CHAR(13) + CHAR(10) + 'GRANT CONNECT TO ' + @User
                        + CHAR(13) + CHAR(10) + 'EXEC sp_addrolemember '
                        + '''' + @Role + '''' + ',' + '''' + @User + ''''
                        + CHAR(13) + 'END'
                ...
                ELSE 
                    SET @sql = @sqlDB
                        ...
                        + '''' + @User + '''' + ')' + CHAR(13) + CHAR(10)
                        + 'BEGIN' + CHAR(13) + 'CREATE USER ' + @User
                        + ' FOR LOGIN ' + '[' + @Login + ']' + CHAR(13)
                        + CHAR(10) + 'GRANT CONNECT TO '+'[' + @User+']' + CHAR(13)
                        + CHAR(10) + 'EXEC sp_addrolemember ' + '''' + @Role
                        + '''' + ',' + '''' + @User + '''' + CHAR(13) + 'END'
